...
def get_dataloader(img_folder: str, act_csv: str, batch_size: int, normalize=False, motion_blur=False, 
    ...
    :param act_csv The csv containing the predictions with their corresponding image name
