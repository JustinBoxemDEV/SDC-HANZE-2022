""" Implementation of the 2dracing game with the gym library
    ...
    Sources:
    https://github.com/techwithtim/Pygame-Car-Racer/tree/main/tutorial4-code
...
GRASS = scale_image(pygame.image.load("src/MachineLearning/ReinforcementLearning/RLExamples/2DRacingGym/imgs/grass.jpg"), 2.5)
TRACK = scale_image(pygame.image.load("src/MachineLearning/ReinforcementLearning/RLExamples/2DRacingGym/imgs/track.png"), 0.9)
TRACK_BORDER = scale_image(pygame.image.load("src/MachineLearning/ReinforcementLearning/RLExamples/2DRacingGym/imgs/track-border.png"), 0.9)
TRACK_BORDER_MASK = pygame.mask.from_surface(TRACK_BORDER)
FINISH = pygame.image.load("src/MachineLearning/ReinforcementLearning/RLExamples/2DRacingGym//imgs/finish.png")
FINISH_MASK = pygame.mask.from_surface(FINISH)
FINISH_POSITION = (130, 250)
RED_CAR = scale_image(pygame.image.load("src/MachineLearning/ReinforcementLearning/RLExamples/2DRacingGym/imgs/red-car.png"), 0.55)
GREEN_CAR = scale_image(pygame.image.load("src/MachineLearning/ReinforcementLearning/RLExamples/2DRacingGym/imgs/grey-car.png"), 0.55)
