""" Assetto Corsa enviroment for reinforcement learning in gym+stablebaselines3
...
def reset_pos():
    shortkey('o')
    sleep(2) # sometimes it wont register the shortkey if it happens too fast on a slow computer
    shortkey('y')
...
def get_current_observation():
    ...
    # Attempted assetto to IRL conversion
    ...
    roi = frame[380:420, 70:580] # roi on 480p AC image
